...
<body>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('shengchanshang')">生产商<i id="shengchanshangIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var shengchanshangCell  = document.createElement('td');

						 shengchanshangCell.innerHTML = item.shengchanshang;


			row.appendChild(shengchanshangCell);
			...
			var yaopinxiangqingCell  = document.createElement('td');
						  ...
						  if(item.yaopinxiangqing != null && item.yaopinxiangqing != "" && item.yaopinxiangqing.length >= 11){
			  	yaopinxiangqingCell.innerHTML = item.yaopinxiangqing.substring(0, 10) + "..."; 
			  }else{
			  	yaopinxiangqingCell.innerHTML = item.yaopinxiangqing;
			  }


			row.appendChild(yaopinxiangqingCell);
