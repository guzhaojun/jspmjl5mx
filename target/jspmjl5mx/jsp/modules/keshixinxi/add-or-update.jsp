...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>医生人数</label>
										<input id="yishengrenshu" name="yishengrenshu" class="form-control" placeholder="医生人数">
									</div>
									<div class="form-group col-md-6">
										<label>科室简介</label>
										<textarea name="keshijianjie" class="form-control" id="keshijianjie" rows="3"></textarea>
									</div>
	...
	<script>
		...
		function dataBind(){
			...
			$("#yishengrenshu").val(ruleForm.yishengrenshu);	
			$("#keshijianjie").val(ruleForm.keshijianjie);
		}		
		//图片显示
		function showImg(){
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.yishengrenshu != null && res.data.yishengrenshu != ''){

					$("#yishengrenshu").val(res.data.yishengrenshu);
					}
					if(res.data != null && res.data != '' && res.data.keshijianjie != null && res.data.keshijianjie != ''){

					$("#keshijianjie").val(res.data.keshijianjie);
					}
				}
			});  
            }
