						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="chongwuming" name="chongwuming" class="form-control" v-model="ruleForm.chongwuming" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>宠物状况</label>

									<input id="chongwuzhuangkuang" name="chongwuzhuangkuang" class="form-control" v-model="ruleForm.chongwuzhuangkuang" readonly>
									</div>
