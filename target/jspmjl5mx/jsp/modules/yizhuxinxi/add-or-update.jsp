		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑医嘱信息</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>医嘱信息管理</span></li>
								<li class="breadcrumb-item active"><span>编辑医嘱信息</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">医嘱信息信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>宠物名</label>
										<input id="chongwuming" name="chongwuming" class="form-control" placeholder="宠物名">
									</div>
									<div class="form-group col-md-6">
										<label>宠物状况</label>
										<input id="chongwuzhuangkuang" name="chongwuzhuangkuang" class="form-control" placeholder="宠物状况">
									</div>
									<div class="form-group col-md-6">
										<label>医嘱</label>
										<textarea name="yizhu" class="form-control" id="yizhu" rows="3"></textarea>
									</div>
									<div class="form-group col-md-6">
										<label>日期</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "yizhuxinxi/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("yizhuxinxi/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("yizhuxinxi/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			...
			$("#chongwuming").val(ruleForm.chongwuming);	
			$("#chongwuzhuangkuang").val(ruleForm.chongwuzhuangkuang);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.chongwuming != null && res.data.chongwuming != ''){

					$("#chongwuming").val(res.data.chongwuming);
					}
					if(res.data != null && res.data != '' && res.data.chongwuzhuangkuang != null && res.data.chongwuzhuangkuang != ''){

					$("#chongwuzhuangkuang").val(res.data.chongwuzhuangkuang);
					}
