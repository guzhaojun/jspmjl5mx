...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>生产商</label>
										<input id="shengchanshang" name="shengchanshang" class="form-control" placeholder="生产商">
									</div>
									<div class="form-group col-md-6">
										<label>数量</label>
									...
									<div class="form-group col-md-6">
										<label>药品详情</label>
										<textarea name="yaopinxiangqing" class="form-control" id="yaopinxiangqing" rows="3"></textarea>
									</div>
	...
	<script>
		...
		function dataBind(){
			...
			$("#shengchanshang").val(ruleForm.shengchanshang);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.shengchanshang != null && res.data.shengchanshang != ''){

					$("#shengchanshang").val(res.data.shengchanshang);
					}
