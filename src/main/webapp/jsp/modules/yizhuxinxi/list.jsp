...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">医嘱信息管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>医嘱信息列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">医嘱信息列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('chongwuming')">宠物名<i id="chongwumingIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('chongwuzhuangkuang')">宠物状况<i id="chongwuzhuangkuangIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var chongwumingCell  = document.createElement('td');

						 chongwumingCell.innerHTML = item.chongwuming;


			row.appendChild(chongwumingCell);
			var chongwuzhuangkuangCell  = document.createElement('td');

						 chongwuzhuangkuangCell.innerHTML = item.chongwuzhuangkuang;


			row.appendChild(chongwuzhuangkuangCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("yizhuxinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"yizhuxinxi");
